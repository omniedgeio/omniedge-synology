...
description_cht="端到端企業 VPN 解決方案，無需公網 IP，無需端口轉發，無需反嚮代理。"
changelog="Notice: uninstall the old version before installing."
changelog_chs="启动修复，注意：本次更新需要卸载套件后重新安装。"
changelog_cht="啓動修複，註意：本次更新需要卸載套件後重新安裝。"
displayname="Omniedge"
maintainer="brucebot, mtx2d, imnkscom"
